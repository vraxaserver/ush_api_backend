            ...
            for i, sd in enumerate(branch_services):
                ...
                svc, created = Service.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "is_for_male": sd["male"], "is_for_female": sd["female"],
