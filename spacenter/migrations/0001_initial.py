        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="International dialing code (e.g., +1, +971)",
                        max_length=10,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_en",
                    models.CharField(
                        max_length=100, null=True, verbose_name="city name"
                    ),
                ),
                (
                    "name_ar",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_en",
                    models.CharField(
                        max_length=150, null=True, verbose_name="service name"
                    ),
                ),
                (
                    "name_ar",
                ...
                (
                    "is_home_service",
                    models.BooleanField(
                        default=False, verbose_name="available for home service"
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Leave blank to use base price for home service",
                        max_digits=10,
                        null=True,
                        validators=[django.core.validators.MinValueValidator(0)],
                        verbose_name="price for home service",
                    ),
                ),
                (
                    "is_for_male",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="e.g., 'Relaxation', 'Pain Relief', 'Couples'",
                        max_length=255,
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="List of benefits as key-value pairs",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to="services/images/", verbose_name="image"
                    ),
                ),
                (
                    "alt_text",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_en",
                    models.CharField(
                        max_length=200, null=True, verbose_name="branch name"
                    ),
                ),
                (
                    "name_ar",
                ...
                (
                    "address_en",
                    models.CharField(max_length=500, null=True, verbose_name="address"),
                ),
                (
                    "address_ar",
                    models.CharField(max_length=500, null=True, verbose_name="address"),
                ...
                (
                    ...
                    models.TimeField(
                        default="09:00", verbose_name="default opening time"
                    ),
                ),
                (
                    "default_closing_time",
                    models.TimeField(
                        default="21:00", verbose_name="default closing time"
                    ),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="active")),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Is currently operational",
                        verbose_name="on service",
                    ),
                ),
                (
                    "sort_order",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="spacenter.service",
                        verbose_name="services can perform",
                    ),
                ),
                (
                    "spa_center",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Base price for this arrangement type",
                        max_digits=10,
                        validators=[django.core.validators.MinValueValidator(0)],
                        verbose_name="base price",
                    ),
